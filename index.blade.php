            ...
            <ul>
               <li>
                  <ul>
                     ...
                     <li>
                        <a href="{{ route ('guru.tampil') }}" class="nav-link" title="Data Guru">
                           <i class="far fa-calendar-alt"></i>
                           <span>Data Guru</span>
                        </a>
                     </li>
                     <li>
                        <a href="{{ route ('mapel.tampil') }}" class="nav-link" title="Data Mapel">
                           <i class="far fa-calendar-alt"></i>
                           <span>Data Mapel</span>
                        </a>
                     </li>
                     <li>
                        <a href="{{ route ('prodi.index') }}" class="nav-link" title="Data Prodi">
                           <i class="far fa-calendar-alt"></i>
                           <span>Data Prodi</span>
                        </a>
                     </li>
                     <li>
                        <a href="{{ route ('siswa.index') }}" class="nav-link" title="Data Siswa">
                           <i class="far fa-calendar-alt"></i>
